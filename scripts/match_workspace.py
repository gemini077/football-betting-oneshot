...
(function(){
  ...
  $('#backToBet').onclick=()=>{$('#betReview').hidden=true;$('#betEdit').hidden=false};$('#betConfirmed').onchange=()=>{$('#finalConfirmBet').disabled=!$('#betConfirmed').checked};
