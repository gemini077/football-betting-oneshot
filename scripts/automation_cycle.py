...
def _summary(payload: dict) -> dict:
    ...
    allowed = {
        ...
        "input_provenance_failure_stages",
        ...
        "verified_paired_count", "total_pair_version_rows",
        "promotion_eligible_pair_version_rows", "verified_pair_version_rows",
        "promotion_eligible_unique_matches", "verified_unique_matches",
        "version_history_match_groups", "extra_version_rows",
        "checkpoint_status", "early_stop_status",
